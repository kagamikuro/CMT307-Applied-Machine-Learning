...
Usage:
    ...
    copy VOC2012 folder to root of Mask_RCNN project

    Train a new model starting from ImageNet weights.
    and execute the commend from root of Mask_RCNN project
    python samples/voc/mcrnn_voc2012.py train --dataset=./ --model=imagenet --year=2012
